...
def add_argument(parser):
    ...
    parser.add_argument("--eef_rot_dist_coef", type=float, default=1)
    parser.add_argument("--eef_up_rot_dist_coef", type=float, default=2)
    ...
    parser.add_argument("--lift_dist_coef", type=float, default=200)
