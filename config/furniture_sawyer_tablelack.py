...
def add_argument(parser):
    ...
    parser.add_argument("--rot_dist_coef", type=float, default=0.1)
    parser.add_argument("--pos_dist_coef", type=float, default=5)
    ...
    parser.add_argument("--phase_bonus", type=float, default=50)
