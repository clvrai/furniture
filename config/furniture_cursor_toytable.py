...
def add_argument(parser):
    ...
    parser.add_argument('--connect_rew', type=float, default=5, help='rew for connecting')
    ...
    parser.add_argument('--aligned_rew', type=float, default=50, help='rew for successful pick and rot')
