...
for f in "${furnitures[@]}"; do
    echo "python -m run --algo bc --run_prefix ik_${f} --env furniture-sawyer-v0 --unity False --gpu 0 --record_video False --max_episode_steps 500 --furniture_name ${f} --demo_path demos/Sawyer_${f}/Sawyer"
    python -m run --algo bc --run_prefix ik_${f} --env furniture-sawyer-v0 --unity False --gpu 0 --record_video False --max_episode_steps 500 --furniture_name ${f} --demo_path demos/Sawyer_${f}/Sawyer
done
