...
class FurnitureCursorToyTableEnv(FurnitureEnv):
    ...
    def _place_objects(self):
        ...
        # complete toy_table
        # pos_init = {
        #         '0_part0': [ 0.21250838, -0.1163671,   0.02096991],
        #         '4_part4': [-0.30491682, -0.09045364,  0.03429339],
        #         '3_part3': [ 0.38134436, -0.11249256,  0.02096991],
        #         '2_part2': [ 0.12432612, -0.13662719,  0.02096991],
        #         '1_part1': [ 0.29537311, -0.12992911,  0.02096991]
        #         }
        # quat_init = {
        #         '0_part0': [0.706332, 0.70633192, 0.03309327, 0.03309326],
        #         '4_part4': [ 0.00000009, -0.99874362, -0.05011164,  0.00000002],
        #         '3_part3': [ 0.70658149,  0.70706735, -0.00748174,  0.0272467 ],
        #         '2_part2': [0.70610751, 0.7061078 , 0.03757641, 0.03757635],
        #         '1_part1': [0.70668613, 0.70668642, 0.02438253, 0.02438249]
        #         }
        ...
        #         }
        pos_init = {
            '4_part4':[-0.34684698 + 0.05, -0.12887974, 0.03418991],
            '2_part2':[0.03472849 - 0.0285, 0.11868485 - 0.05, 0.02096991]
            }
        quat_init = {
            '4_part4':[0.00000009, -0.99874362, -0.05011164, 0.00000002],
            '2_part2':[-0.70610751, 0.7061078, -0.03757641, 0.03757635]
    ...
    def _compute_reward(self, action):
        ...
        connection site.
        """
        rew = pick_rew = ctrl_penalty = success_rew = 0
        site_dist_rew = site_up_rew = connect_rew = aligned_rew = 0
        ...
        c0_ctrl_penalty, c1_ctrl_penalty = (
            2 * np.linalg.norm(c0_moverotate, 2),
            np.linalg.norm(c1_moverotate, 2),
        )
        ctrl_penalty = -self._env_config["ctrl_penalty"] * (
            c0_ctrl_penalty + c1_ctrl_penalty
        )
