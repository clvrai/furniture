...
def argsparser():
    ...
    parser.add_argument('--path', type=str, default='../models/assets/objects/bench_bjoderna_0208.xml')
...
def main(config):
    ...
    root = tree.getroot()
    rescale(tree, root, config.mult, outpath=config.outpath, translate=config.translate, rotate=config.rotate)
